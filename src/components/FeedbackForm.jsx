...
//             try {
//                 console.log(`Fetching interview ${interviewId} for interviewer ${interviewerId}`);
...
//                 const interviewData = {
//                     ...response.data,
//                     candidate: response.data.candidate || { name: 'Unknown Candidate' },
//                     jobId: response.data.jobId || { jobName: 'N/A' },
//                     date: response.data.date || null,
//                     startTime: response.data.startTime || 'Unknown time'
//                 };
...
//                     </Typography>
//                     <Typography>
//                         <strong>Job:</strong> {interview?.jobId?.jobName || 'N/A'}
//                     </Typography>
//                 </Grid>
//                 <Grid item xs={12} sm={6}>
//                     <Typography>
...
//                                         <InputLabel id="Technical Skills">{skill.label}</InputLabel>
//                                         <Select
//                                             name={skill.name}
//                                             id="Technical Skills"
//                                             sx={{width:175}}
