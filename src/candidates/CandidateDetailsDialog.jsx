...
const downloadCandidateResume = async (id) => {
  const response = await axios.get(`https://hire-onboardbackend-production.up.railway.app/api/resumes/download/${id}`, {
    responseType: 'blob'
  });
  return response;
};
...
const previewCandidateResume = async (id) => {
  const response = await axios.get(`https://hire-onboardbackend-production.up.railway.app/api/resumes/preview/${id}`, {
    responseType: 'blob'
  });
  return response;
};
        ...
        <ResumeContent>
          {candidate?.resume ? (
            isResumeLoading ? (
              ...
              <iframe
                src={`https://hire-onboardbackend-production.up.railway.app/api/resumes/preview/${candidate._id}`}
