...
const MoveCandidateForm = ({ open, onClose, candidate, onMoveComplete }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const stagesResponse = await axios.get('https://hire-onboardbackend-key.up.railway.app/api/stages/all');
                setStageOptions(stagesResponse.data);

                const rejectionResponse = await axios.get('https://hire-onboardbackend-key.up.railway.app/api/stages/rejection-types');
    ...
    const handleAddRejectionType = async () => {
        ...
        try {
            const response = await axios.post('https://hire-onboardbackend-key.up.railway.app/api/stages/rejection-types', {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.put(`https://hire-onboardbackend-key.up.railway.app/api/candidates/${candidate._id}/stage`, {
                stage: newStage,
                comment,
