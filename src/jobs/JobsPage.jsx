...
//         const jobsResponse = await fetchAlljobs();
//         if (!jobsResponse) {
//           throw new Error("No response received from jobs API");
//         }
...
//         const usersResponse = await getAllUsers();
//         if (!usersResponse) {
//           throw new Error("No response received from users API");
//         }
...
//         // Extract unique recruiter names from jobs
//         const jobRecruiters = allJobs.flatMap(job => {
//           const recruitingPerson = job.jobFormId?.recruitingPerson;
//           return Array.isArray(recruitingPerson) ? 
//             recruitingPerson : 
//             recruitingPerson ? [recruitingPerson] : [];
//         }).filter(Boolean);
